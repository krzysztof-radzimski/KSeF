/*=====================================================================================
    ...
    KSeF.Invoice
    Builder do budowania obiektu adresu (Address) z wykorzystaniem
    wzorca Fluent API. Umożliwia ustawienie kodu kraju, linii adresowych
    oraz numeru GLN (Globalny Numer Lokalizacyjny).
